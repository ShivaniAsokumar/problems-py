""" 
! PROMPT: Given head, the head of the linked list, determine if the list has a cycle. Does the next pointer of the tail node point to another element in the list. Return the node that the tail pointer is point to. Othewise, return null
